...
import {getRecentSearch, setRecentSearch, removeAllRecentSearch, removeRecentSearch, pullDefaultAddress
    , pullShowScreen, pushShowScreen} from '../../util/Utils'
                    ...
                    <div className="middleArea search">
                        <div className="searchHeader">
                            <span className="textInput withDel">
                                <input type="text" title="검색" placeholder="음식명이나 가게명으로 검색하세요."
...
const Content1 = (props) => {
    ...
    if(props.searchResult !== null && props.searchResult.data.length > 0){
        ...
        return (
            ...
            <ListComponent data={props.searchResult.data} bizCtgDtl="" callback = {changeFilter}/>
        )
    }
