...
export default ({match, location, history}) => {
    ...
    useEffect(() => {
        ...
        data.boardContent = data.boardContent.replace(/(?:\r\n|\r|\n)/g, '<br />'); 
        data.boardContent = {__html : '<p>' + data.boardContent + '</p>'}
        setNoticeData(data)
    }, [])
            ...
            <div id="content">
                <div className="">
                    <div className="listContent">
                        ...
                        <div className="contentArea" dangerouslySetInnerHTML = {boardContent}>
                        </div>
                    </div>
                </div>
            </div>
