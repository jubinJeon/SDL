            ...
            <div id="header">
                <div className="headerTop">
                    ...
                    <div className="middleArea">
                        <h1 className="headerTitle">주소검색</h1>
                    </div>
                </div>
            </div>
            <div id="container">
                    ...
                    <div className="">
                        <div className="staticTitleView">
                            <div className="locationSearch">
                                <div>
                                    {/* https 적용시 아래 주석 해제 */}
                                    <Link to={{pathname: ACTION.LINK_CH00002046_ADDRESSSetting_map , type : 1 }} replace className="btn icon location">현 위치로 주소 설정</Link>
    ...
    useEffect(() => {
        ...
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                history.replace({pathname:ACTION.LINK_CH00002046_ADDRESSSetting_map, type: 2 , data: data, state : location.state});
            },
