      ...
      case "LOGIN" : {
        return (
          <Dialog open={show} className="loginAlert">
            ...
            <div className="popButton">
              <ul className="buttonArea">
                <li><button className="default" type="submit" onClick={callback}><strong>확인</strong></button></li>
                <li><button className="apply" type="submit" onClick={callback}><strong>로그인</strong></button></li>
              </ul>
            </div>
          </Dialog>
        )
