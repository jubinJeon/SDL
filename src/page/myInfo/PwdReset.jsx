...
export default ({history}) => {
    ...
    const doResetPw = e => {
        ...
        .then((data) => {
            if(data.code)
                history.replace({pathname:ACTION.LINK_MY_SDL, popupTxt: '비밀번호 변경이 완료되었습니다.'})
                        ...
                        <div className="sectionRow">
                            ...
                            <div className="loginForm">
                                ...
                                <div className="btnWrap">
                                    <button type="submit"  className={isActive ? "btn login apply" :"btn login disable"}><strong>변경</strong></button>
                                </div> 
                            </div>
                            </form>
                        </div>
