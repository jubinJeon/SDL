...
export default ({history}) => {
    ...
    const handleLogout = () => {
        ...
        .then((data) => {
            if(data.code) 
                history.replace({pathname:ACTION.LINK_MYPAGE, popupTxt: '로그아웃 되었습니다.'})
        })
    }
    ...
    const changeNickname = () => {
        ...
        .then((data) => {
            if(data.code) {
                history.replace({pathname:ACTION.LINK_MYPAGE, popupTxt: '회원정보 수정이 완료되었습니다.'})
            }
        })
        .catch((err) => {
                        ...
                        <div className="sectionRow">
                            <div className="loginForm">
                                    ...
                                    <li>
                                        ...
                                        <span className="rightCell">
                                            <span className="textInput withDel">
                                                ...
                                                <button className="delInput" type="button" onClick={onHandleclear}>삭제</button>
                                            </span>
                                        </span>
                                    </li>
                                    <li>
                                ...
                                <div className="btnWrap fullWidth topBlock">
                                    <button onClick={changeNickname} className="btn login default"><strong>완료</strong></button>
                                </div>
                            </div>
                        </div>
