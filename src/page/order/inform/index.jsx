...
import { pullCartData, numberFormat, unescapehtmlcode } from '../../../util/Utils' 
...
export default ( {history, location} ) => {
    ...
    useEffect(() => {
        if(seconds === 0) {
            history.replace(ACTION.LINK_HOME);
            history.push(ACTION.LINK_ORDER_HISTORY);
            clearTimeout(timeouts.current)
            timeouts.current = [];
    ...
    // const sum = (price) => {
    //     setTprice((prev) => prev + Number(price))
    //     console.log(tprice)
    // }
    ...
    //     var price = 0
    //     if(orderData.menus) {
    //         orderData.menus.forEach(element => {
            ...
            <div id="container">
                <div id="content">
                    ...
                    <div className="fixedBtn">
                        <Link to={ACTION.LINK_HOME} className="btn addCart">홈으로</Link>
                        {/* <a className="btn addOrder">주문내역 확인</a> */}
